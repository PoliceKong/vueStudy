	...
	<div id="caseD">
			...
			<el-header height="100px">
				<div style="margin-top: 30px">
					<table>
						<tr>
							<th>案件名称：</th>
							<th>{{ this.$store.state.caseName }}</th>
							<th style="padding-left: 20px">案件编号：</th>
							<th>{{ this.$store.state.caseNum }}</th>
						</tr>
					</table>
					...
					<div class="elB">
						<el-button
							plain
							type="primary"
							@click="addCaseDialogVisible = true"
							>案件登记
						</el-button>
						<el-button plain type="success">案件查询</el-button>
					</div>
				</div>
			</el-header>
			<el-container>
		...
		<el-dialog :visible.sync="addCaseDialogVisible" title="案件注册">
			...
			>
				...
				<el-form-item>
					<el-button type="primary" @click="resetDiaoLogCase"
						>重置
					</el-button>
					<el-button @click="addCase">保存</el-button>
				</el-form-item>
			</el-form>
		</el-dialog>
	</div>
...
export default {
	...
	methods: {
		...
		toCaseInfo() {
			this.$store.dispatch('selecCaseInfo')
